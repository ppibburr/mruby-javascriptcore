LIB_GOBJECT_PATH = "/usr/lib/i386-linux-gnu/libgobject-2.0.so"
LIB_GTK_PATH = "/usr/lib/i386-linux-gnu/libgtk-3.so.0"
LIB_WEBKIT_PATH = "/usr/lib/libwebkitgtk-3.0.so"
module GObject
  module Lib
    extend FFI::Lib
    ffi_lib LIB_GOBJECT_PATH
...
module Gtk
  ...
  class Window < FFI::AutoPointer
    ...
    def resize i,i2
      Gtk::Lib.gtk_window_resize(self,i,i2)
    end
  end
end
